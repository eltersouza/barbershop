...
const Hero = () => (
  <>
    <div className="absolute h-2 flex flex-row-reverse">
      <button className="text-black rounded bg-white">Log In</button>
    </div>
    <div className="relative pt-16 pb-32 flex content-center items-center justify-center"
      ...
      <div className="absolute top-0 w-full h-full bg-center bg-cover"
        style={{
          backgroundImage: "url(/img/barbershop.jpg)"
        }}>
